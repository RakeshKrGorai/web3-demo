			...
			<div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
				<div className = "flex flex-1 justify-start flex-col mf:mr-10">
					...
					<button type="button" onClick={connectWallet} className="flex flex-row justify-center items-center my-5 bg-[#2952e3] p-3 rounded-full cursor-pointer hover:bg-[#2546bd]">
						...
						<div className="grid sm:grid-cols-3 grid-cols-2 wfull mt-10">
							<div className= {`rounded-tl-2xl ${commonStyles}`}>
								Reliability	
							</div>
							<div className= {`sm:rounded-tr-none rounded-tr-2xl ${commonStyles}`}>
								Security
							</div>
							...
							<div className= {`sm:rounded-bl-none rounded-bl-2xl ${commonStyles}`}>
								Low Fees	
							</div>
			...
			<div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
				...
				<div className="p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism">
					...
					{false ? (
						...
						className = "text-white mt-2 w-full border-[1px] rounded-full p-2 border-[#3d4f7c] cursor-pointer"
						>
						Send Now
						</button>
					)}
